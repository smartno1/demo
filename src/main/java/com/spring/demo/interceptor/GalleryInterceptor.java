...
public class GalleryInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        log.info("gallery interceptor preHandle()");
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        List<String> uriList = Arrays.asList("/gallery/del","api/gallery/mod/**");

        // 현재 요청 URI 정보 알아내기
        String requestURI = request.getRequestURI();
        log.info("postHandler requestURI - {}", requestURI);
        ...
        if (uriList.contains(requestURI) && method.equalsIgnoreCase("GET")) {
            log.info("gallery interceptor postHandle() start! ");
...
//
            Gallery valiDto = (Gallery) modelMap.get("gallery");
