...
import com.spring.demo.member.dto.KaKaoUserInfoDTO;
import com.spring.demo.member.service.KakaoService;
...
import static com.spring.demo.member.domain.SNSLogin.KAKAO;
import static com.spring.demo.util.LoginUtils.LOGIN_FLAG;
import static com.spring.demo.util.LoginUtils.LOGIN_FROM;
