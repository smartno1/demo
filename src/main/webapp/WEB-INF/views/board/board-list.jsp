                        ...
                        <table class="table table-dark table-striped table-hover articles">
                            ...
                            <c:forEach var="b" items="${bList}">
                                <tr id="trlect2">
                                    ...
                                    <td>${b.writer}(${b.account})</td>
                                    <td class=cnt>${b.viewCnt}</td>
                                    <td class=cnt>${b.likeCnt}</td>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination pagination-lg pagination-custom">
                                    ...
                                    <c:if test="${pm.prev}">
                                        <label >
                                            <li class="page-item"><a class="page-link"
                                                    href="/board/list?pageNum=${pm.beginPage - 1}&amount=${pm.page.amount}&type=${s.type}&keyword=${s.keyword}">prev
                                                </a>
                                            </li>
                                        </label>
                                    </c:if>
                                    ...
                                    <c:if test="${pm.next}">
                                        <label>
                                            <li class="page-item"><a class="page-link"
                                                    href="/board/list?pageNum=${pm.endPage + 1}&amount=${pm.page.amount}&type=${s.type}&keyword=${s.keyword}">next
                                                </a>
                                            </li>
                                        </label>
                                    </c:if>
