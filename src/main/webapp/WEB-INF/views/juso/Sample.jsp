...
<form name="form" id="form" method="post">
	...
	<div id="callBackDiv">
		<table>
			<tr>
				<td>우편번호             </td><td><input type="text"  style="width:50px;" id="zipNo"  name="zipNo" readonly/></td>
				<td><input type="button" onClick="goPopup();" value="주소 검색"/></td> 
			</tr>
			<tr><td>도로명주소           </td><td><input type="text"  style="width:500px;" id="roadAddrPart1"  name="roadAddrPart1" readonly/></td></tr>
			<tr><td>지번                 </td><td><input type="text"  style="width:500px;" id="jibunAddr"  name="jibunAddr" readonly/></td></tr>
